...
export default function PositioningAndAudience({
  ...
  return (
    <section id="who-we-help" className="bg-[#0DA191] py-16 md:py-24">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 space-y-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {audiences.map((a) => (
            ...
            >
              <div className="w-9 h-9 rounded-full bg-white/20 flex items-center justify-center text-white text-lg shrink-0">
                <i className={a.icon} />
              </div>
              <div>
